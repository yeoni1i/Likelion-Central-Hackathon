        ...
        String prompt = """
                당신은 아토피 피부 관리 서비스의 일간 리포트를 작성하는 AI입니다.
                               ...
                               \s
                                ...
                                1. [최근 7일 식단]에 제공된 메뉴들을 분석하세요.
                                2. 오타나 띄어쓰기 차이(예: 돈까스, 돈 까 스, 돈가스)가 있더라도 동일한 음식으로 정제하여 가공하세요.
                                3. 개별 메뉴명을 단순 나열하지 말고, 주요 원재료나 알레르기 유발 성분 카테고리(예: 돼지고기, 밀가루, 유제품, 튀김류 등)로 추출/분류하세요.
                                4. 분류된 성분별 섭취 횟수를 집계하여 가장 많은 순서대로 최대 4개까지 'riskFoods' 배열을 만드세요.
                                5. 'riskFoodTitle'에는 가장 주의해야 할 성분을 언급하며 추천 문장(예: "유제품과 밀가루 제품을 유의하는걸 추천해요")을 한 문장으로 작성하세요.
                                6. 만약 최근 7일 식단 기록이 없거나 데이터가 부족하면 'riskFoodTitle'은 "자주 섭취한 식단을 주의 깊게 관찰해 보세요.", 'riskFoods'는 빈 배열 []로 반환하세요.
                ...
                
                                {
                                  ...
                                  "riskFoodTitle": "유제품과 밀가루 제품을 유의하는걸 추천해요",
                                  "riskFoods": [
                                    {
                                      "foodName": "유제품, 밀가루",
                                      "reactionCount": 5
                ...
                
                                {
                                  ...
                                  "triggerFactor": null,
                                  "triggerFactors": [],
                                  "riskFoodTitle": "자주 섭취한 식단을 주의 깊게 관찰해 보세요.",
                                  "riskFoods": []
                                }
                               \s
